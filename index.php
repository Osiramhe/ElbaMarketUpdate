...
function fillProduct ($conn){
    $outputGenres = '';
    $sql = "SELECT * FROM farmproduce LIMIT 8 OFFSET 7";
    $result = $conn->query($sql);
...
?>
    ...
    <style>
        ...
        .tparrows, .tp-rightarrow, .gyges, .noSwipe{
            display:none;
            color: black;
        }
        .txt-m-103{
...
<body class="animsition">
	...
	<div class="sec-item flex-w">
		...
		<div class="of-hidden size-w-2 respon2">
			<div class="hov-img1 pos-relative">
				<img src="images/potatoes-144248.jpg" alt="IMG">
			...
			<div class="size-w-4 p-t-105 p-b-90 p-r-15 respon3">
				...
				<div class="p-b-32">
					...
					<p class="txt-s-102 cl9">
						Corn reduces the risk of Anemia. It is also rich in Vitamin B12, folic acid and iron which helps in the production of red blood cells in the body. It enhances energy and a miracle for those underweight. Keeps your skin healthy.
					</p>
				</div>
				
				<div class="flex-w">
					<a href="shop.php" class="flex-c-m txt-s-103 cl6 size-a-2 how-btn1 bo-all-1 bocl11 hov-btn1 trans-04">
						Shop now
						<span class="fa fa-chevron-right m-l-7"></span>
						<span class="fa fa-chevron-right"></span>
					</a>
	...
	<!-- Back to top -->
	<div class="btn-back-to-top bg0-hov" id="myBtn" style="margin-bottom:1.5em">
