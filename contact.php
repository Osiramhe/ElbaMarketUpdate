...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ( empty($name) OR empty($phone) OR empty($message) OR !filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            $recipient = "elbamarketglobal@gmail.com";
	...
	<section class="container bg0 p-b-90">
		<div class="row">
			...
			<div class="col-sm-12 col-md-12 col-lg-12 m-rl-auto p-b-10">
				<div class="p-t-75 p-l-70 p-rl-0-lg" id="form-box">
					...
					<form id="contact-form" class="validate-form" method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" name="contact">
						<div class="row">
							...
							<div class="col-lg-6 p-b-20">
								<div class="m-l--5 m-rl-0-lg validate-input" data-validate = "Valid email is: ex@abc.xyz">
									<input class="txt-s-115 cl3 plh1 size-a-25 bo-all-1 bocl15 focus1 p-rl-20" type="text" name="email" placeholder="Your Email *" required>
								</div>
							</div>
						...
						<div class="flex-l p-t-10">
							<button class="flex-c-m txt-s-103 cl0 bg10 size-a-2 hov-btn2 trans-04" type="submit" name="submitBtn">
								Send us now
							</button>
						</div>
					</form>
